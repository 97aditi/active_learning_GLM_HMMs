...
def mglm_al(seed, T, initial_inputs, K, true_mglm, test_mglm, input_list, burnin = 150, n_iters=300):
    """ Bayesian active learning for fitting the model"""

    print("Fitting MGLM using active learning")
    ...
    # wmeans_list contains means of laplace approximated distribution 
    # weights_list contains sampled weights (mean over Gibbs iterations)
    ...
    # Store entropy pf model parameters
    if K>1:
    ...
    for t in range(T):
        ...
        x_new, index = selectbestinput(test_mglm, input_list, weights_sampled, pis_sampled)
        ...
        # Write a permute function to get over this
